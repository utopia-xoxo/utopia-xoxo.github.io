...
.formInput:focus {
  ...
  outline: none;
  box-shadow: 0 0 5px rgba(250, 192, 122, 1);
}
...
.mainHeader::after {
    ...
    height: 400px;
    margin-left: 50px;
    background: url('design84_main.jpg') center / contain no-repeat;
}
...
@media(max-width:850px) {
    ...
    *[id^="link_"] {
    ...
    .navs {
        ...
        left: auto;          /* 左基準を解除 */
        background: #fffb;
        transform: translateX(100%); /* 右側の画面外に隠す */
        transition: .5s;
        z-index: 9998;
    }
    .view.navs {
        transform: translateX(0); /* 画面内に滑り込ませる */
    }
